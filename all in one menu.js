(function () {
  ...
  // ════════════════════════════════════════════════════════════
  //  PASTE YOUR SCRIPTS BELOW
  // ════════════════════════════════════════════════════════════

  const SCRIPTS = {

    dino: function () {(function () {
  ...
  document.addEventListener('mouseup', () => { drag = false; });
      ...
      // ── PASTE YOUR COOKIE CLICKER SCRIPT HERE ─────────────
...
(function(){
	...
	console.log('Cheats UI loaded. Ctrl+Q to toggle.');
      ...
      // ── PASTE YOUR 99 MATHS SCRIPT HERE ───────────────────


      // ──────────────────────────────────────────────────────
    },

    blooket: function () {// ==UserScript==
...
createSidebarPath("Credits", "code", creditsPage);
    ...
    img.onerror = img.onabort = () => {
      ...
      // ── PASTE YOUR BLOOKET SCRIPT HERE ────────────────────
  ...
  const GAMES = {
    dino:    { label: 'Dino Game',      icon: '🦕' },
    cookie:  { label: 'Cookie Clicker', icon: '🍪' },
    maths:   { label: '99 Maths',       icon: '🔢' },
    blooket: { label: 'Blooket',        icon: '🎮' },
  };
  ...
  style.textContent = `
    ...
    #__inj-body { padding: 12px; display: flex; flex-direction: column; gap: 8px; }
    #__inj-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
    .inj-btn {
    ...
    #__inj-open-dino:hover { background: #222; border-color: #4caf7d; color: #4caf7d; }
    #__inj-open-dino:active { transform: scale(0.97); }
  `;
  document.head.appendChild(style);
  ...
  menu.innerHTML = `
    ...
    <div id="__inj-body">
      <div id="__inj-grid">
        ${Object.entries(GAMES).map(([key, g]) => `
          <button class="inj-btn" data-game="${key}">
    ...
    <div id="__inj-footer">
      <span id="__inj-footer-label">🦕 Dino won't work on chrome://dino</span>
      <button id="__inj-open-dino">Open dino site ↗</button>
    </div>
  `;
  document.body.appendChild(menu);
  ...
  document.querySelectorAll('.inj-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      setStatus(`Running ${GAMES[key].label}...`, 'run');
      try {
        SCRIPTS[key]();
        setStatus(`✓ ${GAMES[key].label} ran!`, 'ok');
      } catch (e) {
  ...
  document.getElementById('__inj-open-dino').addEventListener('click', () => {
    window.open('https://elgoog.im/dinosaur-game/', '_blank');
  });
